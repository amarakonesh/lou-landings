...
export const featureSwiper: FeatureSwiperType[] = [
  {
    id: '#image1',
    text: '01',
    title: 'Générez des revenus avec vos espaces',
    content:
      'Louez vos logements ou salles disponibles à une large communauté de voyageurs. Publiez vos annonces en quelques clics et recevez vos paiements rapidement via mobile money, carte bancaire ou transfert sécurisé.',
  },
  {
    id: '#image2',
    text: '02',
  ...
  },
  {
    ...
    content:
      'Avec LOU, trouvez rapidement des logements et salles vérifiés pour vos séjours ou événements. Réservez en toute simplicité grâce à un paiement sécurisé et une confirmation instantanée.',
  },
]
